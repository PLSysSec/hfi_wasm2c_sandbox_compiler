...
"#define WASM2C_HFI_VOLATILE volatile\n"
"#else\n"
"#define WASM2C_HFI_VOLATILE\n"
"#endif\n"
"\n"
"#define wasm2c_asmmov_load_anytype(base, offset, data)                                               \\\n"
"    asm WASM2C_HFI_VOLATILE(\"mov (%2, %1), %0\\n\"                                                     \\\n"
"    : \"=r\"(data)                                                                                     \\\n"
"    : \"r\"(offset), \"r\"(base)                                                                         \\\n"
"    : \"memory\"                                                                                       \\\n"
"    );\n"
"\n"
"\n"
"#define wasm2c_asmmov_store_anytype(base, offset, data)                                              \\\n"
"    asm WASM2C_HFI_VOLATILE(\"mov %0, (%2, %1)\\n\"                                                     \\\n"
"    :                                                                                                \\\n"
"    : \"r\"(data), \"r\"(offset), \"r\"(base)                                                              \\\n"
"    : \"memory\"                                                                                       \\\n"
"    );\n"
"\n"
...
"  }\n"
"\n"
"#define DEFINE_NONHFI_ASM_LOAD(name, act_t, signed_wasmrep_t, wasmrep_t)                 \\\n"
"  static inline wasmrep_t name(wasm_rt_memory_t* mem, u64 addr, const char* func_name) { \\\n"
"    MEMCHECK(mem, addr, act_t);                                                          \\\n"
"    act_t out_result;                                                                    \\\n"
"    wasm2c_asmmov_load_anytype(mem->data, addr, out_result);                             \\\n"
"    WASM2C_SHADOW_MEMORY_LOAD(mem, func_name, addr, sizeof(act_t));                      \\\n"
"    WASM2C_SHADOW_MEMORY_LOGLOAD(mem, func_name, addr, sizeof(act_t), out_result);       \\\n"
"    wasm_asm(\"\" ::\"r\"(out_result));                                                      \\\n"
"    return (wasmrep_t)(signed_wasmrep_t)out_result;                                      \\\n"
"  }\n"
"\n"
"#define DEFINE_NONHFI_ASM_STORE(name, act_t, wasmrep_t)                                              \\\n"
"  static inline void name(wasm_rt_memory_t* mem, u64 addr, wasmrep_t value, const char* func_name) { \\\n"
"    MEMCHECK(mem, addr, act_t);                                                                      \\\n"
"    act_t wrapped = (act_t)value;                                                                    \\\n"
"    wasm2c_asmmov_store_anytype(mem->data, addr, wrapped);                                           \\\n"
"    WASM2C_SHADOW_MEMORY_STORE(mem, func_name, addr, sizeof(act_t));                                 \\\n"
"    WASM2C_SHADOW_MEMORY_LOGSTORE(mem, func_name, addr, sizeof(act_t), wrapped);                     \\\n"
"  }\n"
"\n"
...
"\n"
"#elif defined(WASM_NONHFI_USE_ASM_MOVE)\n"
"\n"
"#define DEFINE_LOAD DEFINE_NONHFI_ASM_LOAD\n"
"#define DEFINE_STORE DEFINE_NONHFI_ASM_STORE\n"
"\n"
"#elif defined(WASM_USE_SEGMENT)\n"
"\n"
...
"\n"
"#ifdef HFI_EMULATION\n"
"static void fix_stack_first_wasmfile(wasm2c_sandbox_t* const sbx) {\n"
"  uint32_t* stack_pointer_address = wasm_get_stack_pointer_address(sbx);\n"
"  if (stack_pointer_address == 0) {\n"
"    return;\n"
"  }\n"
"  if (*stack_pointer_address > 1048576) {\n"
"    return;\n"
"  }\n"
"\n"
"  // Put the temporary stack at the end of the wasm heap\n"
"  *stack_pointer_address = ((uint64_t)sbx->w2c_memory.max_pages - 1) * 64 * 1024;\n"
"}\n"
"#endif\n"
"\n"
