...
"  if (sbx->w2c___stack_pointer > sbx->w2c___global_base) {\n"
"    return;\n"
"  }\n"
"\n"
"  // Put the temporary stack at the end of the wasm heap\n"
"  uint64_t tmp_stack = ((uint64_t)sbx->w2c_memory.max_pages - 1) * 64 * 1024;\n"
"  uint64_t stack_size = sbx->w2c___stack_pointer;\n"
"  sbx->w2c___stack_pointer = tmp_stack;\n"
"  uint32_t new_stack = w2c_malloc(sbx, stack_size);\n"
"  sbx->w2c___stack_pointer = new_stack;\n"
"}\n"
"#endif\n"
"\n"
