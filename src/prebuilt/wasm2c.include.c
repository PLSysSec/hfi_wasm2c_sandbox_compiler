...
"}\n"
"\n"
"#define wasm2c_asmmov_load_anytype(offset, data)                                                     \\\n"
"    asm(\"mov (%1), %0\\n\"                                                                             \\\n"
"    : \"=r\"(data)                                                                                     \\\n"
"    : \"r\"(offset)                                                                                    \\\n"
"    : \"memory\"                                                                                       \\\n"
...
"\n"
"\n"
"#define wasm2c_asmmov_store_anytype(offset, data)                                                    \\\n"
"    asm(\"mov %0, (%1)\\n\"                                                                             \\\n"
"    :                                                                                                \\\n"
"    : \"r\"(data), \"r\"(offset)                                                                         \\\n"
"    : \"memory\"                                                                                       \\\n"
...
"    MEMCHECK(mem, addr, act_t);                                                          \\\n"
"    act_t out_result;                                                                    \\\n"
"    wasm2c_asmmov_load_anytype(MEM_ACCESS_REF(mem, addr), out_result);                   \\\n"
"    WASM2C_SHADOW_MEMORY_LOAD(mem, func_name, addr, sizeof(act_t));                      \\\n"
...
"    MEMCHECK(mem, addr, act_t);                                                                      \\\n"
"    act_t wrapped = (act_t)value;                                                                    \\\n"
"    wasm2c_asmmov_store_anytype(MEM_ACCESS_REF(mem, addr), wrapped);                                 \\\n"
"    WASM2C_SHADOW_MEMORY_STORE(mem, func_name, addr, sizeof(act_t));                                 \\\n"
"    WASM2C_SHADOW_MEMORY_LOGSTORE(mem, func_name, addr, sizeof(act_t), wrapped);                     \\\n"
"  }\n"
"\n"
...
"\n"
"#elseif defined(WASM_NONHFI_USE_ASM_MOVE)\n"
"\n"
"#define DEFINE_LOAD DEFINE_NONHFI_ASM_LOAD\n"
"#define DEFINE_LOAD DEFINE_NONHFI_ASM_STORE\n"
"\n"
"#else\n"
"\n"
